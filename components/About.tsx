  ...
  return (
    ...
    className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
        ...
        <div className='space-y-8 px-0 md:px-8 flex items-center flex-col'>
            ...
            <a href='https://drive.google.com/uc?export=download&id=1-a7wrKur4DMl96VZAAGbcbUzORTXwqzi' > <button className='bg-[#ff9b20] p-2 text-lg hover:bg-[#ff9b20]/90 rounded-md text-gray-100'> <DownloadForOfflineIcon/> Download </button> </a>
        </div>
    </motion.div>
  )
}
