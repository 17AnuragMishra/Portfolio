  ...
  return (
    ...
    className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
        ...
        <div className='space-y-8 px-0 md:px-8 flex items-center flex-col'>
            <p className='text-base'>Greetings! I am <b style={{color:'#F7AB0A'}}>Anuarg Mishra</b>, a tech enthusiast pursing Bachelor of Technology in Computer Science Engineering. from early age interest in technology, I am planning to pursue my career in Software development or purely in Web Development filed. From academic to extra curriculum activity, always ready to learn and dive deep into new technology irrespective of dedication requires.<br /> <br/>
